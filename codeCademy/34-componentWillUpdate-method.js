...
export class TopNumber extends React.Component {
  ...
  // If we need to do non-React setup before a component renders, such as checking the window size or interacting with an API, then componentWillUpdate is a good place to do that:
